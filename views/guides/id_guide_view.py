...
class IdGuideView(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        lbl_title = ctk.CTkLabel(header, text=self.controller.lang_manager.get("guide_id_title"), font=ctk.CTkFont(size=18, weight="bold"), text_color=self.controller.theme_manager.get("accent"))
        ...
        text_area.insert("0.0", self.controller.lang_manager.get("guide_id_text"))
