...
class AIAmnesiaConfigFrame(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.txt_summary = ctk.CTkTextbox(info_frame, height=80, font=("Consolas", 13), fg_color=self.controller.theme_manager.get("bg_dark"), border_color=self.controller.theme_manager.get("border"), border_width=1, text_color=self.controller.theme_manager.get("text"))
        ...
        self.chk_id.select()
        self.txt_identity = ctk.CTkTextbox(info_frame, height=120, font=("Consolas", 13), fg_color=self.controller.theme_manager.get("bg_dark"), border_color=self.controller.theme_manager.get("border"), border_width=1, text_color=self.controller.theme_manager.get("text"))
        ...
        self.txt_guidelines = ctk.CTkTextbox(info_frame, height=120, font=("Consolas", 13), fg_color=self.controller.theme_manager.get("bg_dark"), border_color=self.controller.theme_manager.get("border"), border_width=1, text_color=self.controller.theme_manager.get("text"))
        ...
        self.txt_moods = ctk.CTkTextbox(info_frame, height=120, font=("Consolas", 13), fg_color=self.controller.theme_manager.get("bg_dark"), border_color=self.controller.theme_manager.get("border"), border_width=1, text_color=self.controller.theme_manager.get("text"))
        ...
        self.chk_aff.select()
        self.txt_aff = ctk.CTkTextbox(info_frame, height=120, font=("Consolas", 13), fg_color=self.controller.theme_manager.get("bg_dark"), border_color=self.controller.theme_manager.get("border"), border_width=1, text_color=self.controller.theme_manager.get("text"))
        ...
        self.txt_self = ctk.CTkTextbox(info_frame, height=80, font=("Consolas", 13), fg_color=self.controller.theme_manager.get("bg_dark"), border_color=self.controller.theme_manager.get("border"), border_width=1, text_color=self.controller.theme_manager.get("text"))
